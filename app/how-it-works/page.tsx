      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-border/60 bg-card/70 p-10 shadow-xl backdrop-blur-xl">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Search opportunities, filter by skills or categories, and connect with IEDC mentors. Use the form to submit projects, request support, or post paid micro-projects for student talent.
          </p>
        </div>
      </div>
    </main>
